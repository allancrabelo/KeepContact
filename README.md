...
<p align="center">
  <img width="100%" src="https://github.com/user-attachments/assets/0b49aa6f-be79-4c0e-9f38-e0cae7648842" alt="KeepContact Interface"/>
</p>
...
```mermaid
flowchart LR
    A[User submits contact form] --> B{Valid?}
    B -- Yes --> C[Add to contact list]
    B -- No --> D[Show error message]
    C --> E[Render contact in table]
    E --> F[Enable edit/delete]
    F --> G[Update or remove entry]
```
---
## 🎨 Figma Prototype

<p align="center"> <img src="https://github.com/user-attachments/assets/0b49aa6f-be79-4c0e-9f38-e0cae7648842" alt="Figma Design" width="600" /> </p> <p align="center"> <strong>Visual Planning:</strong><br> UI/UX prototypes built with Figma to ensure consistent design flow and user experience across all screen sizes. </p>
